"""
Thanks to https://github.com/ipaleka/algorand-contracts-testing for most of these functions
...
# CREATE ASSET
def create_fakita_inu_signed_txn(public_key, private_key):
    ...
    txn = AssetConfigTxn(
        ...
        unit_name="FAKE",
        asset_name="fakita_inu",
        #should we make these things account 2?
        manager=public_key,
        reserve=public_key,
        freeze=public_key,
        clawback=public_key)
